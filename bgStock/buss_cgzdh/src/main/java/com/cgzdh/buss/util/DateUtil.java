...
public class DateUtil {
	...
	public static final String FORMAT16 = "yyyy";
	public static SimpleDateFormat timedf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	public static SimpleDateFormat datedf = new SimpleDateFormat("yyyy-MM-dd");
	...
	public static Date stringToDate(String strDate, String srcDateFormat, String dstDateFormat) {
		SimpleDateFormat format=new SimpleDateFormat(srcDateFormat);
		format.setLenient(false);
		Date rtDate = null;
		Date tmpDate = format.parse(strDate, new ParsePosition(0));
	...
	// System.out.println(getYearMonthDay(parseStringToDate("2009-11-2 12:1:21",
	// FORMAT7)));
	...
	// ""));
	// System.out.println("test parseStringToDate: " +
	// parseStringToDate("1990-01-1 00:00:00", ""));
	//
	...
	// System.out.println("test betweenTwoDays: " + betweenTwoDates(date,
	// addDay(date, 2)));
	// System.out.println("test getWeekNum: " + getWeekNum(addDay(date, -2)));
	// System.out.println("test getWeekByDate: " +
	// getWeekByDate(parseDateToString(date, "")));
	// System.out.println("test getMonthBegin: " +
	// getMonthBegin(parseDateToString(date, "")));
	// System.out.println("test getMonthEnd: " +
	// getMonthEnd(parseDateToString(date, "")));
	// System.out.println("test isSameWeekDates: " + isSameWeekDates(date,
	// addDay(date, -2)));
	//
...
//		if(value.match("/^((?:19|20)\d\d)-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01])$/")) {//yyyy-mm-dd 
//			time = stringToDate(value, DateUtil.FORMAT16, DateUtil.FORMAT7).getTime();
//		}
		
		
		switch (value.length()) { // 字符
		case 4:
			time = stringToDate(value, DateUtil.FORMAT16, DateUtil.FORMAT7).getTime();
			break;
		case 6:
			time = stringToDate(value, DateUtil.FORMAT14, DateUtil.FORMAT7).getTime();
			break;

		case 8:
			time = stringToDate(value, DateUtil.FORMAT12, DateUtil.FORMAT7).getTime();
			break;
		case 10:
			time = stringToDate(value, DateUtil.FORMAT1, DateUtil.FORMAT7).getTime();
			break;
		case 14:
			time = stringToDate(value, DateUtil.FORMAT13, DateUtil.FORMAT7).getTime();
			break;
		case 19:
			time = stringToDate(value, DateUtil.FORMAT7, DateUtil.FORMAT7).getTime();
			break;
		default:
